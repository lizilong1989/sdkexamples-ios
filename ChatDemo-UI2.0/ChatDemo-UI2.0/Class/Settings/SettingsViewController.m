...
{
    [[EMClient sharedClient].options setIsDeleteMessagesWhenExitGroup:control.isOn];
}
...
//    [self.ipSwitch setOn:[[EMClient sharedClient].options enableDnsConfig] animated:YES];
